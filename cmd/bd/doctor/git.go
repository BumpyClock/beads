...
// CheckGitHooksDoltCompatibility is a no-op now that the Dolt backend has been removed.
// Kept for backward compatibility with callers that reference this check.
